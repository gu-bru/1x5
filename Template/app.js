(function () {
    ...
    //UNITY STUFF
    var buildUrl = "Build";
    var loaderUrl = buildUrl + "/1x5.loader.js";
    var config = {
        dataUrl: buildUrl + "/1x5.data",
        frameworkUrl: buildUrl + "/1x5.framework.js",
        codeUrl: buildUrl + "/1x5.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "G. Brunbauer",
        productName: "1x5 - Übung mit Spaß",
        productVersion: "2.20  10.8.2023",
    };
